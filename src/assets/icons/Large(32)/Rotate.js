...
export default function Rotate({ color }) {
  ...
  <Path d="M25.5956 15.5333C25.5956 10.2682 21.3274 6 16.0622 6C13.0709 6 10.4013 7.37776 8.65344 9.53333" stroke={color} stroke-width="2" stroke-linecap="round"/>
  ...
  <Path d="M6.52894 15.5336C6.52893 20.7987 10.7972 25.0669 16.0623 25.0669C19.0536 25.0669 21.7232 23.6891 23.4711 21.5336" stroke={color} stroke-width="2" stroke-linecap="round"/>
