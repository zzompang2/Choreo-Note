...
export default function Dancer({ color }) {
  return (
    ...
    <Circle cx="16" cy="16" r="13" fill="#646464"/>
    ...
    <Path d="M25.8536 0.853552C25.5386 0.53857 25.7617 0 26.2071 0H31C31.5523 0 32 0.447715 32 1V5.79289C32 6.23835 31.4614 6.46143 31.1464 6.14645L25.8536 0.853552Z" fill="#646464"/>
    </Svg>
  )
}
